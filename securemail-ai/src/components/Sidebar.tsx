...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const TextLabel = ({ children, count, highlight }: { children: React.ReactNode, count?: number, highlight?: boolean }) => (
    <div 
  ...
  const NavItem = ({ 
      ...
      return (
        ...
        >
            ...
            <TextLabel count={count} highlight={highlight}>{label}</TextLabel>
        </div>
      );
  };
